137
a:4:{s:8:"template";a:1:{s:15:"login/index.tpl";b:1;}s:9:"timestamp";i:1434344023;s:7:"expires";i:1434344029;s:13:"cache_serials";a:0:{}}<html>
	<head>
...
<div id="main">
	...
	<form method="post" action="/android/admin.php/login/prologin" id="login-form">
		<ul>	
			...
			<li style="height:25px" class="dark-row">
				...
				<img style="cursor:pointer;" alt="看不清，换一张" onclick="this.src='/android/admin.php/login/code/'+Math.random()" src="/android/admin.php/login/code" />
			</li>
			<li style="height:25px" class="light-row">
